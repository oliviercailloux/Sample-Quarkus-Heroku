...
//		}
		...
		final Server server = JettyWebContainerFactory.create("http://localhost:8080/",
				ImmutableMap.of(ServletProperties.JAXRS_APPLICATION_CLASS, appName));
...

		{
			...
			final WebTarget target = client.target(uri).path("app/counter");
